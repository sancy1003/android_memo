...
public class MemoDelGridViewAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<Memo_data> data;

    public MemoDelGridViewAdapter(Context context, ArrayList<Memo_data> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.item_gridview_del_memo, parent, false);
        //}
